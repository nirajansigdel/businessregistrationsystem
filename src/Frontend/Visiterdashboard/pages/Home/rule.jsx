...
export default function Grule() {
  return (
    <div className="pl-16 flex flex-col justify-center gap-12 py-12 bg-[#405698] px-24 ">
      <p className="flex  justify-center text-center text-[#FFBB00]  text-2xl font-bold ">
        Company Registration in Nepal: Quick Requirements
      </p>
      <div className="flex items-start flex-col gap-6 text-white pl-16">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ol className="flex flex-col gap-1 list-decimal pl-6">
            <li>
              Shareholders must be over 16 years with Nepali citizenship or a
              valid passport.
            </li>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ol className="flex flex-col gap-1 list-decimal pl-6 ">
            ...
            <li>
              Identification documents (citizenship certificates or passports)
        ...
        <div className="flex flex-col gap-1">
          <span>
            Ensure documents are signed, notarized, and details match. Seek
            legal advice for compliance.
          </span>
          <span>
            Note: Verify requirements with authorities for updates before
            proceeding.
          </span>
        </div>
      </div>
